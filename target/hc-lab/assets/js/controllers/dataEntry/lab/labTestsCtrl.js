angular.module("labModule").controller("labTestsCtrl", ['$scope','$location', 'commonService','labPatientService', '$state','ngDialog','$timeout', '$parse', function($scope,$location, commonService,labPatientService, $state,ngDialog,$timeout,$parse) {
	...
	//x ray image view
	function viewFile(labId,categoryName,testName){
