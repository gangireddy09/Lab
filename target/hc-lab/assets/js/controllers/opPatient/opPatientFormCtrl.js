angular.module("labModule").controller("opPatientFormCtrl",['$scope','$stateParams','opPatientService', 'opService','commonService','$state','ngDialog','$parse',function($scope,$stateParams,opPatientService, opService,commonService, $state,ngDialog, $parse){
